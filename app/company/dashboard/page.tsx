...
export default function CompanyDashboard() {
  ...
  return (
    <div className="mobile-dashboard-shell" style={{ minHeight: "100vh", background: "var(--paper)", fontFamily: "var(--font-geist-sans)" }}>
      ...
      <header className="mobile-dashboard-header" style={{ background: "linear-gradient(135deg, #0A1D33 0%, #0F2A4A 60%, #1a3a5c 100%)", color: "#fff", padding: "0 24px", boxShadow: "0 2px 12px rgba(10,29,51,0.25)" }}>
        <div className="mobile-dashboard-header-inner" style={{ maxWidth: 1280, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", height: 64 }}>
          ...
          <div className="mobile-dashboard-header-actions" style={{ display: "flex", alignItems: "center", gap: 10 }}>
      ...
      {/* ── BODY LAYOUT ── */}
      <div className="mobile-dashboard-body" style={{ maxWidth: 1280, margin: "0 auto", padding: "28px 20px", display: "grid", gridTemplateColumns: "230px 1fr", gap: 24 }}>

        {/* ── SIDEBAR ── */}
        <aside className="mobile-dashboard-sidebar" style={{ position: "sticky", top: 24, height: "fit-content" }}>
        ...
        {/* ── MAIN PANEL ── */}
        <main className="mobile-dashboard-main" style={{ minWidth: 0 }}>
